...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MovieViewHolder>
    ...
    public void setMovies(@NonNull final List<Movie> movies) {
        ...
        if (data != null) {
            ...
            final List<MoviesResponse.Movie> newData = new ArrayList<>(data);
    ...
    private static class MovieDiffUtilCallback extends DiffUtil.Callback {
        ...
        @NonNull private final List<MoviesResponse.Movie> oldList;
        @NonNull private final List<MoviesResponse.Movie> newList;

        MovieDiffUtilCallback(@NonNull final List<MoviesResponse.Movie> oldList,
                              @NonNull final List<MoviesResponse.Movie> newList) {
        ...
        private static boolean areItemsTheSame(final MoviesResponse.Movie oldItem,
                                               final MoviesResponse.Movie newItem) {
        ...
        private static boolean areContentsTheSame(final MoviesResponse.Movie oldItem,
                                                  final MoviesResponse.Movie newItem) {
            return oldItem.id == newItem.id;
        }
    }
